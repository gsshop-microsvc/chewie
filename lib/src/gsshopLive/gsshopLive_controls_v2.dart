...
class GsshopLiveControlsV2 extends StatefulWidget {
  const GsshopLiveControlsV2({
...
class _MaterialControlsState extends State<GsshopLiveControlsV2>
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            if (chewieController.isFullScreen) _buildProgressBar(),
            SizedBox(
